...
def CommUpdateDisplay2():
    ...
    if read_storeRequest1!=read_storeRequest2:
     return '<meta http-equiv="refresh" content="120"><html>LOADING..... This can Take up to 20 minuites  This can Take up to 20 minuites (Note: If Bing Sheet is Absent or incorrectly formatted Google active communities will be used such that Bing Ads will reflect Communities not found in Google inventory </html>'

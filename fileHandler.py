...
def CommListFileHandler():
    ...
    return "<meta http-equiv='Cache-Control' content='no-cache, no-store, must-revalidate'><meta http-equiv='refresh' content='0;URL=https://bdxapilink.com/DisplayCommUpdate'><html>did not forward</html>"

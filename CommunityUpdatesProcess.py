...
def KeywordGen(NewDataFrame,MatchType,SearchChan):
 ...
 while count < hilecount:
  ...
  URL_Struct2="https://www.newhomesource.com/communities/"+"market-"+str(NewDataFrame['Market ID'][count])+"/?communityname="+str(NewDataFrame['Community Name'][count]).replace(" ",%20)#.lower()+"%20community&refer="

...
def KeywordGen(NewDataFrame,MatchType,SearchChan):
 ...
 while count < hilecount:
  ...
  communityName=communityName.replace("Homesites","").replace("","lots").replace("-"," ").replace("_","").replace("40s","")\
               .replace("40'","").replace("40","").replace("45s","").replace(" Homesites ","").replace("homesites","").replace("()","")\
               .replace("45'","").replace("45","").replace("50s","").replace("50'","").replace("50","").replace("55s","").replace("  ","")\

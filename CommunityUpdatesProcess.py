...
def filterNonParticipators(FrameToBeFiltered):
 ...
 if len(CatchDiscards)!=0:
  ...
  while count2<len(CatchDiscards):
   ...
   print("CatchDiscards 8 :",CatchDiscards[8])
   print("CatchDiscards 9 :",CatchDiscards[9])
   print("CatchDiscards 10 :",CatchDiscards[10])
   print("CatchDiscards 11 :",CatchDiscards[11])
   print("CatchDiscards 12 :",CatchDiscards[12])      

...
def KeywordGen(NewDataFrame,MatchType,SearchChan):
 ...
 while count < hilecount:
  ...
  try:
   ...
   print(string(URL_Struct1))
   print("!!!!!!!!!!!! LOCATION OF INTERVENTION FOR NEW SCRIPT ELEMENT 5 !!!!!!!!!!!!!!")
   print(string(URL_Struct1))
   print("!!!!!!!!!!!! LOCATION OF INTERVENTION FOR NEW SCRIPT ELEMENT 6 !!!!!!!!!!!!!!")
   print(URL_Struct1.find('WWW'))
   print("!!!!!!!!!!!! LOCATION OF INTERVENTION FOR NEW SCRIPT ELEMENT 7 !!!!!!!!!!!!!!")
   print(URL_Struct1.find('www'))
   print("!!!!!!!!!!!! LOCATION OF INTERVENTION FOR NEW SCRIPT ELEMENT 8 !!!!!!!!!!!!!!")

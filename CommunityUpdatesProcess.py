...
def KeywordGen(NewDataFrame,MatchType,SearchChan):
 ...
 while count < hilecount:
  try:
   ...
   print('_________________________Title2A.append(NewDataFrame['City'][count]+" "+"New Homes for sale")_________________________')
   Title3A.append("Schedule a New Home Tour Today")
   print('_________________________Title3A.append("Schedule a New Home Tour Today")_________________________')
   TextA.append("Find your family a perfect new home at Legacy at East Greenwich 55+ in Clarksboro, NJ!")
   print('_________________________ TextA.append("Find your family a perfect new home at Legacy at East Greenwich 55+ in Clarksboro, NJ!")_________________________')
   Text2A.append("New Homes offer security, energy efficiency, and peace of mind. Skip the remodel, Buy New!")
   print('_________________________Text2A.append("New Homes offer security, energy efficiency, and peace of mind. Skip the remodel, Buy New!")_________________________')
   Path1A.append(NewDataFrame['City'][count].replace(" ","-"))
   print('_________________________Path1A.append(NewDataFrame['City'][count].replace(" ","-"))_________________________')
   Path2A.append("New Homes")
   print('_________________________Path2A.append("New Homes")_________________________')
   Final_URL.append("https://www.newhomesource.com/community/",NewDataFrame['State'][count],NewDataFrame['City'][count].lower)
   print('__________________________________ Final_URL.append("https://www.newhomesource.com/community/",NewDataFrame['State'][count],NewDataFrame['City'][count].lower)_________________________________________________________________________________')
